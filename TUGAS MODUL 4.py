print('Kelompok 3')
print('Shata’ Hibrizi Al Fa’Iq', 21120123130066) 
print('Bima Saputra Aji', 21120123130104) 
print('Salsabila Luthfiyani', 21120123130060) 
print('Farhan Nasrullah', 21120123120039)
print('Sistem Kasir')

def cost(produk, jumlah):
    pakaian = {
        'kaos': 200000,
        'celana': 350000,
        'jaket': 400000,
...
def diskon(produk, jumlah, harga):
    potongan = 0
